...
// do not use templates here, we are not preventing any duplication by using templatees and knowing
// type helps catch errors easily while compiling (do not have to wait for template to be
// instantiated)
