...
void test1()
{
    ...
    msg.subscribeId_ = 0x75bcd15;
    msg.startGroup_ = 0x3ade68B1;
    msg.startObject_ = 0x69f6bc7;
    msg.endGroup_ = 0xd3ed78e;
    msg.endObject_ = 0x13de4355;
    msg.subscriberPriority_ = 0xff;
